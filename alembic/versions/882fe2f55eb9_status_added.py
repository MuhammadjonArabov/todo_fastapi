...
Revision ID: 882fe2f55eb9
Revises: 
Create Date: 2024-07-17 11:32:40.200703
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('pending', 'perform', 'completed', name='statustodo'), nullable=True),
